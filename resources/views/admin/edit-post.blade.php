...
@section('content')
    ...
    <div class="l-container u-clear">
        ...
        <main class="l-main js-main">
            ...
            <form action="{{url('admin/updateArticle')}}" method="POST" class="form" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <div class="form-body">
                    <input type="text" id="title" name="title" class="input input-text" value="{{$article->title}}">
                </div>
                <label for="contents" class="form-title">CONTENTS</label>
                <div class="form-textarea">
                    <textarea name="contents" id="inquiry" cols="30" rows="10" class="input input-contents">
                        {{$article->contents}}
                    </textarea>
                </div>
                @if(count($errors) > 0)
